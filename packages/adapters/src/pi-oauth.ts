...
> = {
  [CHATGPT_OAUTH_PROVIDER]: {
    loginLabel: "Entrar com ChatGPT Plus/Pro",
    hint: "ChatGPT Plus/Pro",
    billing:
      "Sign in with ChatGPT Plus or Pro. Uses your OpenAI subscription. Quibt Bot does not pay.",
  },
  [COPILOT_OAUTH_PROVIDER]: {
    loginLabel: "Entrar com GitHub Copilot",
    hint: "Copilot",
    billing: "Sign in with GitHub Copilot. Uses your Copilot subscription. Quibt Bot does not pay.",
  },
  [XAI_OAUTH_PROVIDER]: {
    loginLabel: "Entrar com SuperGrok ou X Premium",
    hint: "SuperGrok / key",
    billing:
      "Sign in with SuperGrok or X Premium, or paste an xAI API key. Quibt Bot does not pay.",
  },
};
