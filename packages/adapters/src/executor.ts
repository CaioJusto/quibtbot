...
export function createRunExecutor(deps: ExecutorDeps) {
  return {
    ...
    async continueRun(runId: string, workerId: string) {
      ...
      // instead of one `run.findUnique` per streamed token.
