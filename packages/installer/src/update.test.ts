...
describe("runUpdate", () => {
  it("creates verified backup, retains local image ids, and only changes env after backup", async () => {
    ...
    expect(rollback.release).toBe("0.2.9");
    expect(rollback.images).toEqual([
      { reference: "ghcr.io/quibt/quibt-stack:0.2.9", id: "sha256:stack-old" },
      { reference: "ghcr.io/quibt/quibt-supervisor:0.2.9", id: "sha256:supervisor-old" },
      { reference: "ghcr.io/quibt/quibt-computer:0.2.9", id: "sha256:computer-old" },
    ]);
