...
<p align="center">
  ...
  <a href="https://github.com/CaioJusto/quibtbot/releases/latest"><img src="https://img.shields.io/badge/release-v0.2.9-brightgreen.svg" alt="v0.2.9" /></a>
</p>
...
> **Where this is:** `v0.2.9` is published and running. What that means concretely: the
...
| Platform | Installer |
| --- | --- |
| macOS (Apple silicon) | [`QuibtBot.dmg` (v0.2.9)](https://github.com/CaioJusto/quibtbot/releases/download/v0.2.9/QuibtBot.dmg) |
...
The `v0.2.9` release publishes that signed Apple-silicon app, standalone macOS/Linux
