...
describe("withDesktopRetryHint", () => {
  it("troca a instrução neutra do pacote pelo nome do botão da tela", () => {
    expect(
      withDesktopRetryHint(
        "O download de quibt-computer:0.2.13 falhou 3 vezes (a internet caiu). Confira a internet e rode a instalação de novo — o que já baixou fica guardado.",
      ),
    ).toBe(
      "O download de quibt-computer:0.2.13 falhou 3 vezes (a internet caiu). Confira a internet e clique em Começar instalação de novo — o que já baixou fica guardado.",
    );
    expect(
      withDesktopRetryHint(
  ...
  it("não mexe no que não fala de instalar de novo", () => {
    const update =
      "Este computador tem o Quibt Bot 0.2.10 instalado e este instalador é o 0.2.13. Rode a atualização (quibtbot update) em vez de instalar de novo.";
